          ...
          >
            ...
            <div class="p-6">
              <div class="flex items-center text-xs text-gray-500 mb-2">
                <span>{{ news.category?.categoryName?.[locale] ?? news.category?.categoryName?.en }}</span>
              ...
              <p class="text-gray-600 text-sm line-clamp-3">{{ news.summary?.[locale] ?? news.summary?.en }}</p>
            </div>
          </nuxt-link>
