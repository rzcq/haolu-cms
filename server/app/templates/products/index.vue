          ...
          >
            <div class="relative overflow-hidden pt-4">
              ...
              <div
                ...
                class="absolute top-3 left-3 bg-red-600/80 text-white text-xs px-2 py-1 rounded"
              >
                {{ product.category.categoryName?.[locale] ?? product.productName?.en }}
              </div>
            </div>
            <div class="p-6">
              <h3 class="text-xl font-semibold text-gray-800 mb-2 group-hover:text-primary transition-colors">
                {{ product.productName?.[locale] ?? product.productName?.en }}
              </h3>
              <p class="text-gray-600 mb-4 line-clamp-3 whitespace-pre-wrap">
                {{ product.summary?.[locale] ?? product.summary?.en }}
              </p>
