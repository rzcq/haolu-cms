  ...
  <div class="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
    <div class="flex items-center justify-center gap-2 p-2">
      <a
        ...
        target="_blank"
        rel="noopener"
        class="kb-button flex-1 text-center py-[.4em] px-[1em] text-[1.125rem] rounded-[3px] no-underline transition-all duration-300"
        style="background: #25D366; color: #fff"
      >
        <span class="inline-flex items-center gap-[.5em]">
          <svg viewBox="0 0 448 512" fill="currentColor" class="w-[1em] h-[1em]" aria-hidden="true">
